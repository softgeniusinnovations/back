...
class PaymentController extends Controller
{
    ...
    {
        $agents = Admin::select('id','identity', 'address','telegram_link')->whereIn('type', ['2', '3'])->where('is_login', 1)->where('country_code', Auth::user('admin')->country_code)->where('identity', 'like', '%' . $r->admin_id . '%')->get();
