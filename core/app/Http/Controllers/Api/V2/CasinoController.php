...
//    public $hall;
    public $hall = '3205382';
//    public $bonus_hall = '3205824';
    public $key = 'testhall';
    public $cdnUrl = 'https://static.cdns-stat.com/resources/';
    public $domain = 'https://p333r1m2287.com/';
...
//    favorite casino
    ...
    {
        $favorites = CasinoGame::where('user_id', auth()->id())->pluck('game_id');
    ...
    public function toggleFavorite(Request $request)
    {
        ...
        $favorite = CasinoGame::where('user_id', auth()->id())
    ...
    public function addRecentlyPlayed(Request $request)
    {
        ...
        CasinoGame::updateOrCreate(
            ['user_id' => $userId, 'game_id' => $gameId],
            ['last_played' => now()]
        );

        return response()->json(['message' => 'Game added to recently played']);
    }
    ...
    public function getRecentlyPlayed()
    {
        ...
        $recentlyPlayed = CasinoGame::where('user_id', $userId)
