...
@section('frontend')
    @php
        ...
        $registerContent = getContent('aff_register.content', true);
    @endphp
            ...
            <div class="row g-3 align-items-center justify-content-lg-between">
                ...
                <div class="col-lg-6 col-xl-5">
                    <div class="login-form mt-0">
                        ...
                        @include($activeTemplate . 'partials.register-aff', ['registerContent' => $registerContent, 'policyElement' => $policyElements, 'countries' => $countries, 'currencies' => $currencies])
                    </div>
                </div>
            </div>
        </div>
