                    ...
                    <div class="row">
                        ...
                        @foreach ($providers as $data)
                            <div class="col-md-2 mb-4 local">
                                <div class="border select-payment" style="cursor: pointer; background: #f4f5f7"
                                    data-min_val="{{ $affiliator ? $validAmount:  $data->dep_min_am }}" data-max_val="{{ $data->dep_max_am }}"
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-2 mb-4 local">
                                    <div class="border select-payment" style="cursor: pointer; background: #f4f5f7">
                                        <a href="{{ route('user.withdraw.mobcash') }}">
                        ...
                        <div class="col-md-12 payment-system-area" style="display: none">
                            ...
                            <div class="border py-2">
                                <p class="d-flex px-2 mb-1" style="align-items: center; justify-content:space-between ">
                                    <strong>Bank
                                        Name</strong> <span class="bank-name"></span>
                                </p>
                            </div>
                            <h4>2. Request a Withdraw</h4>
                            ...
                            <div class="form-group">
                                <label for="phone">Withdrawl <span class="bank-name"></span> Wallet Number</label>
                        ...
                        <div class="payment-method-selection"
                            ...
                            <div class="payment-modal-area-start"
                                ...
                                <div class="payment-modal-header" style="border-bottom: 1px solid #ddd; min-height: 80px;">
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (data?.message) {
                                ...
                                $('.dep-note').text(data?.success[0]?.with_note);
