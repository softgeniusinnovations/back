                                        ...
                                        <select class="form-select" name="country" required class="form-control">
                                            @foreach ($countries as $key => $country)
                                                <option data-mobile_code="{{ $country->dial_code }}"
                                                    ...
                                                    {{ $countries->{$agent->country_code}->country == $country->country ? 'selected' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="type" id="type" class="form-control" required>
                                        <option value="1" @selected($agent->type == '1')>Agent</option>
                                        <option value="2" @selected($agent->type == '2')>Cash Agent</option>
                                        <option value="3" @selected($agent->type == '3')>Mob Agent</option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control form--control" name="deposit_commision"
                                            type="text" value="{{ $agent->deposit_commission }}" required min="0"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control form--control" name="withdraw_commision"
                                            type="text" value="{{ $agent->withdraw_commission }}" required
                            ...
                            <div class="col-md-4 ">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="telegram_link" class="form-control"
                                        value="{{ $agent->telegram_link }}" placeholder="Telegram Link" required>
                                </div>
                            </div>
                            <div class="col-md-4 ">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="bot_name" class="form-control"
                                        value="{{ $agent->bot_username }}" placeholder="Bot name" required>
                                </div>
                            </div>
                            <div class="col-md-4 ">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="chat_id" class="form-control"
                                        value="{{ $agent->channel_id }}" placeholder="Chat ID" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="bot_token" class="form-control"
                                        value="{{ $agent->bot_token }}" placeholder="Bot token" required>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    @if ($agent->file)
                                        <img src="{{ asset('/core/public/storage/agent/photo/' . $agent->file) }}" alt="Photo"
                                            width="50">
                                    @endif
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <table class="table">
                                            <tbody class="providers">
                                                @forelse ($agent->transectionProviders as $p)
                                                    <tr class="item">
                                                        <td>
                                                            <div class="form-group">
                                                                ...
                                                                <select name="providers[]" id="providers"
                                                                    ...
                                                                    @foreach ($providers as $key => $provider)
                                                                        <option value="{{ $provider->id }}"
                                                                            @selected(@$p->pivot->transection_provider_id == $provider->id)>
                                                                            {{ $provider->name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                        ...
                                                        <td style="text-align: left">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="wallet_name[]"
                                                                    class="form-control" placeholder="Wallet name"
                                                                    value="{{ @$p->pivot->wallet_name }}" required>
                                                            </div>
                                                        </td>
                                                        <td style="text-align: left">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="wallet_number[]"
                                                                    class="form-control" placeholder="Wallet number"
                                                                    value="{{ @$p->pivot->mobile }}" required>
                                                            </div>
                                                        </td>
                                                        <td style="text-align: left">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="comments[]"
                                                                class="form-control" value="{{ @$p->pivot->comments }}" placeholder="Comments">
                                                        </div>
                                                    </td>
                                                        <td>
                                                            <button type="button"
                                                ...
                                                {{-- @foreach ($providers as $key => $provider)
                                                    <tr>
                                                        <td>{{ $provider->name }}</td>
                                                        <td><input type="text" name="providers[]"
                                                                placeholder="Enter {{ $provider->name }} number"
                                                                class="form-control"
                                                                value="{{ old('providers.' . $key) }}"></td>
                                                    </tr>
                                                @endforeach --}}
                                            </tbody>
                                            <tfoot>
                            ...
                            <div class="col-md-12 only-for-cash-agent" style="display: none">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address" class="form-control"
                                        value="{{ $agent->address }}" placeholder="Agent address" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="balance" class="form-control"
                                        value="{{ $agent->balance }}" placeholder="Balance" required min={{$agent->balance}}>
                                </div>
                            </div>
...
@push('script')
    <script>
        ...
        (function($) {
            ...
            $('select[name=country]').val('{{ $countries->{@$agent->country_code}->country }}');
            let dialCode = $('select[name=country] :selected').data('mobile_code');
            let mobileNumber = `{{ $agent->phone }}`;
