                        ...
                        <div class="login-wrapper">
                            <div class="login-wrapper__top">
                                @php
                                    ...
                                    $contents = $domain ? json_decode($domain->contents, true) : [];
                                @endphp
                                @if($domain)
                                    <h4 class="text-white" style="font-size: 27px">{{ $contents['login']['title'] }}</h4>
                                    <p class="text-white">{{ $contents['login']['subtitle'] }}</p>
                                @else
