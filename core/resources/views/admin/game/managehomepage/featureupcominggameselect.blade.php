...
{{--                            <form action="{{ route('admin.storeFeatureGame') }}" method="POST">--}}
{{--                                @csrf--}}
...
{{--                                                    @endphp--}}
{{--                                                    <tr>--}}
{{--                                                        <input type="hidden" name="league_id" value="{{ $category->id??'' }}">--}}
{{--                                                        <td>--}}
{{--                                                            <input type="checkbox" name="selected_match[]" value="{{ $match->id ?? '' }}">--}}
{{--                                                        </td>--}}
{{--                                                        <td>{{ $match->id ?? 'N/A' }}</td>--}}
...
{{--                                                        <tr>--}}
{{--                                                            <input type="hidden" name="league_id" value="{{ isset($category->{'@id'}) ? $category->{'@id'} : '' }}">--}}
{{--                                                            <td><input type="checkbox" name="selected_match[]" value="{{ isset($match->{'@id'}) ? $match->{'@id'} : '' }}"></td> <!-- Checkbox for each row -->--}}
